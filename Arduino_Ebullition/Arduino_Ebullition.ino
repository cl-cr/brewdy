...
float valTemperature[2] = {NULL, NULL};

//String idSensor[2] = {"1", "7"}; // compte Amaury (test)
String idSensor[2] = {"8", "9"}; // compte invite
...
#define PERIODICITE_CAPTEURS_LOW 30000 // tous les quarts d'heure = 60 000 * 15 ms = 900 000
...
void loop()
{
 ...
 /* if(connexionWifi == 0) {
  ...
  if(keepGoing == 1) {
    ...
    envoieAuESP8266("AT+CIPSEND=2,129");
    recoitDuESP8266(500);
    
    envoieAuESP8266("GET /testServeur3/testCapteur.php?idSensor1="+idSensor[0]+"&valMesure1="+valTemperature[0]+"&idSensor2="+idSensor[1]+"&valMesure2="+valTemperature[1]+" HTTP/1.1\r\nHost: 90.89.213.17\r\n\r\n");
    recupererCommandeESP8266(1000);
